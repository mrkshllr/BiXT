...
def clean_state_dict(state_dict: Dict[str, Any]) -> Dict[str, Any]:
    ...
    for k, v in state_dict.items():
        ...
        # TODO: Note, had to add this due to interesting behaviour with torch2.0 slurm node-crash & loading checkpoints
        name = k[10:] if k.startswith('_orig_mod.') else name
