...
def _cfg_deit3_noinputsize(url='', **kwargs):
    return {
        'url': url,
...
default_cfgs = generate_default_cfgs({
    'deit3_tiny_patch16_224': _cfg_deit3(),
    'deit3_tiny_patch8_224': _cfg_deit3(),
    'deit3_tiny_patch16_allsizes': _cfg_deit3_noinputsize(),
    'deit3_tiny_patch8_allsizes': _cfg_deit3_noinputsize(),
    'deit3_tiny_patch4_allsizes': _cfg_deit3_noinputsize(),
    'deit3_small_patch16_allsizes': _cfg_deit3_noinputsize(),
    'deit3_small_patch8_allsizes': _cfg_deit3_noinputsize(),
    'deit3_small_patch4_allsizes': _cfg_deit3_noinputsize(),
    'deit3_base_patch16_allsizes': _cfg_deit3_noinputsize(),
    'deit3_base_patch8_allsizes': _cfg_deit3_noinputsize(),
    'deit3_base_patch4_allsizes': _cfg_deit3_noinputsize(),
...
# Additional models using the input size from the kwargs -- none defined in config -- for FLOP & Mem computation/scaling
@register_model
def deit3_tiny_patch16_allsizes(pretrained=False, **kwargs) -> VisionTransformer:
    """ DeiT-3 tiny model @ 224x224 from paper (https://arxiv.org/abs/2204.07118).
    """
    model_args = dict(patch_size=16, embed_dim=192, depth=12, num_heads=3, no_embed_class=True, weight_init='jax')
    model = _create_deit('deit3_tiny_patch16_allsizes', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def deit3_small_patch16_allsizes(pretrained=False, **kwargs) -> VisionTransformer:
    """ DeiT-3 tiny model @ 224x224 from paper (https://arxiv.org/abs/2204.07118).
    """
    model_args = dict(patch_size=16, embed_dim=384, depth=12, num_heads=6, no_embed_class=True, weight_init='jax')
    model = _create_deit('deit3_small_patch16_allsizes', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def deit3_base_patch16_allsizes(pretrained=False, **kwargs) -> VisionTransformer:
    """ DeiT-3 tiny model @ 224x224 from paper (https://arxiv.org/abs/2204.07118).
    """
    model_args = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, no_embed_class=True, weight_init='jax')
    model = _create_deit('deit3_base_patch16_allsizes', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def deit3_tiny_patch8_allsizes(pretrained=False, **kwargs) -> VisionTransformer:
    """ DeiT-3 tiny model @ 224x224 from paper (https://arxiv.org/abs/2204.07118).
    """
    model_args = dict(patch_size=8, embed_dim=192, depth=12, num_heads=3, no_embed_class=True, weight_init='jax')
    model = _create_deit('deit3_tiny_patch8_allsizes', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def deit3_tiny_patch4_allsizes(pretrained=False, **kwargs) -> VisionTransformer:
    """ DeiT-3 tiny model @ 224x224 from paper (https://arxiv.org/abs/2204.07118).
    """
    model_args = dict(patch_size=4, embed_dim=192, depth=12, num_heads=3, no_embed_class=True, weight_init='jax')
    model = _create_deit('deit3_tiny_patch4_allsizes', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def deit3_small_patch8_allsizes(pretrained=False, **kwargs) -> VisionTransformer:
    """ DeiT-3 small model @ 224x224 from paper (https://arxiv.org/abs/2204.07118).
    """
    model_args = dict(patch_size=8, embed_dim=384, depth=12, num_heads=6, no_embed_class=True, weight_init='jax')
    model = _create_deit('deit3_small_patch8_allsizes', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def deit3_small_patch4_allsizes(pretrained=False, **kwargs) -> VisionTransformer:
    """ DeiT-3 small model @ 224x224 from paper (https://arxiv.org/abs/2204.07118).
    """
    model_args = dict(patch_size=4, embed_dim=384, depth=12, num_heads=6, no_embed_class=True, weight_init='jax')
    model = _create_deit('deit3_small_patch4_allsizes', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def deit3_base_patch8_allsizes(pretrained=False, **kwargs) -> VisionTransformer:
    """ DeiT-3 base model @ 224x224 from paper (https://arxiv.org/abs/2204.07118).
    """
    model_args = dict(patch_size=8, embed_dim=768, depth=12, num_heads=12, no_embed_class=True, weight_init='jax')
    model = _create_deit('deit3_base_patch8_allsizes', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


@register_model
def deit3_base_patch4_allsizes(pretrained=False, **kwargs) -> VisionTransformer:
    """ DeiT-3 base model @ 224x224 from paper (https://arxiv.org/abs/2204.07118).
    """
    model_args = dict(patch_size=4, embed_dim=768, depth=12, num_heads=12, no_embed_class=True, weight_init='jax')
    model = _create_deit('deit3_base_patch4_allsizes', pretrained=pretrained, **dict(model_args, **kwargs))
    return model


# Update for our experiments
@register_model
...
@register_model
def deit3_tiny_patch8_224(pretrained=False, **kwargs) -> VisionTransformer:
    """ DeiT-3 tiny model @ 224x224 from paper (https://arxiv.org/abs/2204.07118).
    """
    model_args = dict(patch_size=8, embed_dim=192, depth=12, num_heads=3, no_embed_class=True, weight_init='jax')
    model = _create_deit('deit3_tiny_patch8_224', pretrained=pretrained, **dict(model_args, **kwargs))
    return model
