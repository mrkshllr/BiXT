...
class CosineLRScheduler(Scheduler):
    ...
    def _get_lr(self, t):
        if t < self.warmup_t:
            ...
            gamma = self.cycle_decay ** i  # Note: i usually 0 in the 'default' case of t not higher than total epochs
            lr_max_values = [v * gamma for v in self.base_values]
            k = self.k_decay

            if i < self.cycle_limit:  # Note: The 'old' version: lr_min = self.lr_min * gamma, but gamma usually 1
                lrs = [
