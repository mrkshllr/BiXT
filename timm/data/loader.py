...
def create_loader(
        ...
        num_aug_repeats=0,
        num_aug_splits=0,
        no_rr_crop=False,  # MH: Added simple random crop (deit-III paper), inactive in our experiments (BiXT)
        ...
        worker_seeding='all',
        shuffle_anyways=False,  # Added to shuffle dataset for visualisation, even though not training
        generator=None,
):
    re_num_splits = 0
    if re_split:
    ...
    dataset.transform = create_transform(
        ...
        no_rr_crop=no_rr_crop,  # MH: Added simple random crop (deit-III paper), inactive in our experiments (BiXT)
        three_augment=three_augment,  # MH: Added "three_augment"  (deit-III paper)
    )
